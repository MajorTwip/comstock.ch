---
title: Diese Seite neu gebaut – mit Claude Code für rund 30 Franken
date: 2026-06-15
authors:
  - MajorTwip
language: de
...
summary: Letztes Jahr habe ich die Seite auf Next.js migriert. Jetzt läuft sie auf Astro – und diesmal hat den Grossteil der Arbeit Claude Code erledigt. Für rund 30 Franken an Tokens.
---
...
Unterm Strich rund **30 Franken an Tokens**. Für eine komplette Migration inklusive Skripten, neuem Layout, Suche und diesem Bild hier ist das erstaunlich wenig – günstiger als ein Abend Handarbeit, und ich habe nebenbei einiges über Astro gelernt.
