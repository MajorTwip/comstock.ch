...
authors: ["MajorTwip"]
language: en
images: ['./assets/20200726_220902-1024x576.jpg']
summary: "To be able to open both garage doors via OpenHAB, I use a 2-relay board with an ESP01 on it."
---

To be able to open both garage doors via OpenHAB, I use a 2-relay board with an ESP01 on it.

![](./assets/20200726_220902-1024x576.jpg)
